# Story 0.7: Profile View/Edit Screen (Minimal)
...
- Story 0.6 (User Profile API) completed the backend endpoints that this story will consume
...
### Data Models
**Source:** Story 0.6.1 - Type Generation
...
### API Specifications
**Source:** Story 0.6 - User Profile API
...
**Source:** Story 0.7 Acceptance Criteria (Epic 0)
