...
describe("NotificationService", () => {
  ...
  describe("sendBookingConfirmationEmail", () => {
    ...
    it("should include correct subject line for mentor", async () => {
      ...
      expect(mentorEmailLog![1].subject).toBe(
        "Meeting Confirmed with John Mentee",
      );
    });
    ...
    it("should include correct subject line for mentee", async () => {
      ...
      expect(menteeEmailLog![1].subject).toBe(
        "Meeting Confirmed with Jane Mentor",
      );
    });
    ...
    it("should include formatted time range in email body", async () => {
      ...
      expect(mentorEmailLog![1].body).toMatch(
        /Time: \d{1,2}:\d{2} [AP]M - \d{1,2}:\d{2} [AP]M/,
      );
    });
    ...
    it("should include timestamp in email logs", async () => {
      ...
      expect(mentorEmailLog![1].timestamp).toMatch(
    ...
    it("should use custom dashboard URL when provided", async () => {
      ...
      await customService.sendBookingConfirmationEmail(
        mockBooking,
        mentor,
        mentee,
      );
    ...
    it("should use default dashboard URL when not provided", async () => {
      ...
      await defaultService.sendBookingConfirmationEmail(
        mockBooking,
        mentor,
        mentee,
      );
