...
describe("Matching API Routes", () => {
  ...
  const mockMatches: MatchResult[] = [
    {
      ...
      explanation: {
        ...
        summary:
          "Strong match: 2 shared tags, same startup stage, compatible reputation tiers",
      },
    },
    {
      user: {
      ...
      explanation: {
        ...
        reputationCompatible: true,
        summary:
          "Good match: 1 shared tag, same startup stage, compatible reputation tiers",
      },
    },
  ];
  ...
  describe("POST /v1/matching/find-matches", () => {
    ...
    it("should return cached mentee matches for a mentor", async () => {
      ...
      ).mockResolvedValue(menteeMatches);
  ...
  describe("POST /v1/matching/explain", () => {
    it("should return match explanation for cached user pair", async () => {
      ...
      vi.spyOn(MatchingService.prototype, "explainMatch").mockResolvedValue(
        mockExplanation
      );
